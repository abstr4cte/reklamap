...
class AdvertisementsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $ads = [
            ...
            [
                'title' => 'Reklama mobilna - busy reklamowe, Trójmiasto',
                'type' => 'mobile',
                'location' => 'ul. Łużycka 6',
                'city' => 'Gdynia',
                'region' => 'pomorskie',
                'latitude' => 54.5189,
                'longitude' => 18.5312,
                'description' => "Oferujemy kampanie na nośnikach mobilnych w Trójmieście — pojazdy z podświetlanymi ekranami LED jeżdżące według ustalonej trasy przez Gdańsk, Gdynię i Sopot. Kampania obejmuje 6–8 godzin dziennie w wybranych przez klienta godzinach. Zasięg: centrum, dzielnice handlowe, okolice plaż latem. Minimalna kampania: 5 dni roboczych. Idealny format na eventy, otwarcia, promocje sezonowe.",
                'price' => 1800,
                'price_unit' => 'week',
                'width' => 2.50,
                'height' => 1.20,
                ...
                'route_area' => 'Gdańsk, Gdynia, Sopot',
        ...
        // Różne daty dodania (od 5 miesięcy wstecz do niedawna)
        $createdDates = [
            now()->subDays(152),
            now()->subDays(141),
            now()->subDays(130),
