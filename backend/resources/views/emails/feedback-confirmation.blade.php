...
<head>
    ...
    <title>Dziękujemy za Twoje zgłoszenie — ReklaMap</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            <div class="success-badge">✓ Zgłoszenie otrzymane</div>
            <h2 class="greeting">Dziękujemy za Twoje zgłoszenie!</h2>

            <p style="color: #4b5563; line-height: 1.6; margin: 0 0 16px 0;">
                Twoja opinia trafiła do nas i bardzo nam na niej zależy. Dzięki takim zgłoszeniom jak Twoje ReklaMap staje się lepszą platformą — dosłownie.
            </p>

            <p style="color: #4b5563; line-height: 1.6; margin: 0 0 24px 0;">
                Jeśli sprawa wymaga odpowiedzi, odezwiemy się na ten adres email. W przeciwnym razie możesz mieć pewność, że Twoje zgłoszenie zostało odnotowane i trafia prosto do zespołu.
            </p>
            ...
            <p style="color: #4b5563; line-height: 1.6; margin: 0;">
                Jeszcze raz dziękujemy — naprawdę to doceniamy.
            </p>
        </div>
