...
<body>
    ...
    <div class="content">
        ...
        <p>Otrzymujesz ten email, ponieważ poprosiłeś o dostęp do panelu zarządzania Twoimi ogłoszeniami na platformie ReklaMap.</p>
        
        <p>Kliknij poniższy przycisk, aby uzyskać dostęp do wszystkich ogłoszeń powiązanych z Twoim adresem email:</p>
        
        <div style="text-align: center;">
            <a href="{{ url('/zarzadzaj/' . $token->id) }}" class="button">Przejdź do panelu zarządzania</a>
        </div>
