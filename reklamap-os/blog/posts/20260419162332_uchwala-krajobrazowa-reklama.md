---
title: "Uchwała krajobrazowa — co oznacza dla reklamy 2026"
slug: "uchwala-krajobrazowa-reklama"
category: prawo-i-regulacje
meta_description: "Uchwała krajobrazowa 2026: 82 gminy, kary za niezgodną reklamę, status Warszawy/Krakowa/Gdańska. Sprawdź, jak weryfikować nośnik przed podpisaniem umowy →"
image_alt: "Mapa Polski z zaznaczonymi miastami posiadającymi aktywną uchwałę krajobrazową regulującą reklamę outdoor"
image_prompt: "Abstract map of Poland with highlighted cities showing advertising regulation zones, clean minimalist infographic style, blue and orange color scheme, professional business illustration, no text on image"
keywords:
  - uchwała krajobrazowa
  - uchwała krajobrazowa reklama
...
<!-- Angle: Jedyny praktyczny przewodnik dla reklamodawcy i właściciela nośnika — które 82 polskie gminy mają aktywną uchwałę w 2025/2026, co regulują (zakazy, strefy, kary), jak sprawdzić status w BIP przed podpisaniem umowy najmu nośnika. -->
...
Uchwała krajobrazowa to akt prawa miejscowego uchwalany na podstawie **art. 37a ustawy o planowaniu i zagospodarowaniu przestrzennym**. Każda gmina określa w niej samodzielnie — dla swojego obszaru — zasady i warunki sytuowania obiektów małej architektury, tablic i urządzeń reklamowych oraz ogrodzeń.

W praktyce uchwała reguluje:

- **Gabaryty** — maksymalna powierzchnia nośnika (najczęściej 18 m² dla wolnostojących)
- **Lokalizacje** — strefy, w których billboard, baner lub citylight są dozwolone, ograniczone lub zakazane
- **Materiały i estetykę** — kolorystyka, typy podświetlenia, zakaz animacji
...
Kara za nośnik naruszający uchwałę krajobrazową to **iloczyn powierzchni ekspozycji (m²) i 40-krotności stawki zmiennej opłaty reklamowej, powiększony o 40-krotność stawki części stałej** obowiązującej w danej gminie, naliczany za **każdy dzień** trwania naruszenia (art. 37d ustawy krajobrazowej; źródło: bip.poznan.pl). Stawka zmienna to maksymalnie do 0,20 zł/m²/dzień, a stała do 2,50 zł/dzień (górne stawki ustawowe 2026; gmina może uchwalić mniej) — przy billboardzie 18 m² i górnych stawkach kara wynosi 18 × 40 × 0,20 + 40 × 2,50 = **244 zł/dzień**, liczone od dnia stwierdzenia naruszenia.
...
## Jak sprawdzić status uchwały przed podpisaniem umowy

Przed rezerwacją każdego nośnika — zwłaszcza przy kontrakcie dłuższym niż 3 miesiące — warto potwierdzić jego status prawny. Ryzyko przedwczesnego demontażu ponosi reklamodawca, nie właściciel nośnika.
...
Przeglądasz oferty nośników? Filtruj według miasta i sprawdzaj dostępność bezpośrednio u właścicieli → [reklamap.pl/powierzchnie-reklamowe](/powierzchnie-reklamowe)
...
**Jakie kary grożą za niezgodną reklamę?**
Kara to iloczyn powierzchni nośnika (m²) i 40-krotności stawki zmiennej opłaty reklamowej, powiększony o 40-krotność stawki części stałej, naliczany za każdy dzień naruszenia (art. 37d ust. 8 ustawy o planowaniu i zagospodarowaniu przestrzennym). Przykładowo przy górnej stawce do 0,20 zł/m²/dzień i stałej do 2,50 zł/dzień (górne stawki ustawowe 2026) przy formacie 18 m² daje to 18 × 40 × 0,20 + 40 × 2,50 = 244 zł dziennie. Do kary dochodzi nakaz demontażu na koszt właściciela. Po wyroku TK z 2023 (P 20/19) część gmin wstrzymała naliczanie kar, ale w Krakowie i Gdańsku uchwały nadal są egzekwowane (źródło: bip.poznan.pl).
