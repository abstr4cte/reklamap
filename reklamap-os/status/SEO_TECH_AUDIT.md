...
| 10 | **5 padających testów na `master`** (`ManagementTest` ×4 → 422 zamiast 200, `SearchAlertTest` → 302 zamiast 404) — testy nieaktualne, kod OK | `php artisan test` | Naprawić PRZED powyższymi fixami — dziś sieć bezpieczeństwa jest wyłączona, a pre-commit hook omijany | **XS, blokujące** |
