...
4. **STATUS PRAWNY — TYLKO Z OFICJALNYCH ŹRÓDEŁ (nie z blogów operatorów OOH):** przy uchwałach krajobrazowych, przepisach i wyrokach ŹRÓDŁEM PRAWDY są wyłącznie: oficjalne strony miast (BIP, `*.pl` urzędu), dzienniki urzędowe województw, orzecznictwo (WSA/NSA/TK). **NIGDY nie opieraj statusu prawnego na blogach sprzedawców powierzchni** (jetline.pl, billboard-x.pl, znajdzreklame.pl, euroart.pl) — mają interes handlowy i bywają nieaktualne. Zawsze podawaj **stan na datę** („na 2025/2026") — prawo jest dynamiczne: uchwały wchodzą, są częściowo uchylane, zawieszane, a orzecznictwo zmienia obraz po dacie pisania. Rozróżniaj stany: (a) nigdy nie uchwalona; (b) w projekcie/procedowaniu (nie obowiązuje); (c) obowiązuje; (d) obowiązuje mimo częściowego uchylenia; (e) unieważniona w całości. NIE myl „unieważniona przez wojewodę" (stan przejściowy) z aktualnym. **NIE FABRYKUJ prawdopodobnych szczegółów prawnych:** konkretne sygnatury wyroków (np. „II SA/Po 547/23"), numery i daty uchwał, progi gabarytów, symbole i liczbę stref, stawki opłat — podawaj TYLKO gdy masz je z oficjalnego źródła. Jeśli nie masz — pisz ogólnie („uchwała ustala minimalne odstępy", „limit gabarytów", „kilka obszarów o różnym reżimie") zamiast zmyślać wiarygodnie wyglądające liczby. Osobno oznaczaj, czy skutek prawny jest TRWAŁY czy PRZEJŚCIOWY (np. brak obowiązku dostosowania w Poznaniu to skutek braku ustawowego trybu odszkodowania — wyrok TK P 20/19 — który może zniknąć po nowelizacji; NIE „stałe zwolnienie"). **Kontekst:** audyt 2026-07-12 wykrył 3 artykuły z fałszem prawnym (Gdańsk/Łódź/Kraków) opartym na blogach OOH; audyt 2026-07-13 wykrył kolejną warstwę — **zmyślone, wiarygodnie brzmiące szczegóły** w artykułach Poznań i Gdańsk (Gdańsk: „6 obszarów A-F" — realnie 8: SZ/S0/SR/S1/S2/SI/S3/SP; fikcyjne progi 1,25/4,0/9,0 m²; niepotwierdzone sygnatury i stawki). Weryfikacja z oficjalnych źródeł (edziennik.*.uw.gov.pl, trybunal.gov.pl, BIP) jest OBOWIĄZKOWA przed publikacją każdego twierdzenia prawnego.
